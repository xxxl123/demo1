<template>
  <div class="course-wrap" v-if="returnCourseState==1">
    <div class="crumbs">
    ...
    <div class="container">
      <div class="table">
        <el-table :data="tableData" stripe>
          <el-table-column type="index" label="序号" prop="studentCourseId" />
...
export default {
  ...
  methods: {
    getList() {
	  ...
	  api.
	    getReturnCourseState().then(res=>{
	  			
	  		  let state = res;
	  		  console.log(state);
	  		  this.returnCourseState = state;
	  });	
    },
