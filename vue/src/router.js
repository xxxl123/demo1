...
import AdminChoseCourse from './views/admin/AdminChoseCourse.vue'
import Home from "./views/Home";
import StudentCourseComments from "./views/student/StudentCourseComments";
...
const routes = [
  {
    ...
    children: [
	  ...
	  {
	    path: "/student/coursecomments",
	    name: "student-coursecomments",
	    component: StudentCourseComments
	  },
	  ...
	  {
	    path: "/admin/chose/course",
	    name: "admin-chose-course",
	    component: AdminChoseCourse
	  },
      {
        path: "/admin/admin",
        name: "admin-admin",
