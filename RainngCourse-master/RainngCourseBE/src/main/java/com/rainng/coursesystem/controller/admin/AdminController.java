...
public class AdminController extends BaseController {
    ...
    @DeleteMapping("/cancelChoseCourse")
    public void cancelChoseCourse(){
        service.cancelChoseCourse();
    }
    @PostMapping("/openChoseCourse")
    public void openChoseCourse(){
        service.openChoseCourse();

    }
    @DeleteMapping("/cancelReturnCourse")
    public void cancelReturnCourse(){
        service.cancelReturnCourse();
    }
    @PostMapping("/openReturnCourse")
    public void openReturnCourse(){
        service.openReturnCourse();
    }
}
